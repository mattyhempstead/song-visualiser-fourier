...
freqFileName = input("SongFreq file name: ")
songFileName = input("Song file name: ")
...
def drawWaveCircle(points, circle, maxAmplitude):
	...
	for k in range(len(points)-1):
		...
		pointEnd = [
			pointBase[0] + pointAngleVector[0] * maxAmplitude * points[k],
			pointBase[1] + pointAngleVector[1] * maxAmplitude * points[k]
		]
...
while True:
	...
	drawWaveCircle(transformList[transformNum], {"x":350,"y":350,"r":150}, 150)
